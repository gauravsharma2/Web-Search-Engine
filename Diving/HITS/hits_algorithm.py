...
hub_score_file = open("C:/Users/AGM230006/Documents/Diving/HITS/precomputed_scores/hubs_score", 'w')
authority_score_file = open("C:/Users/AGM230006/Documents/Diving/HITS/precomputed_scores/authority_score_1", 'w')
...
def networkx_algo(outlinks_webgraph):
    ...
    hubs, authorities = nx.hits(G, max_iter=900, normalized=True)
...
def get_webgraph_inlinks():
    inlinks_file = open("C:/Program Files/apache-nutch-1.19/runtime/local/crawl/inlinks/part-r-00000", 'r', encoding='utf-8').readlines()
